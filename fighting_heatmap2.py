...
import matplotlib.pyplot as plt, skimage.exposure, skimage.color, skimage.filters, tqdm
...
class Heatmap:
    ...
    # requires model as argument
    def __init__(self, model):
        self.nclasses    = model.output_shape[1]
        self.model       = model
    
    # create masks to make boxes
    ...
    def explain_prediction_heatmap(self, img, title='Heatmap', nmasks=(9, 7, 5, 3, 2)):
        ...
        print('Top classes: ', topclasses.values())
