...
#%%
class ProjectConfig:
    basepath      = "/home/lab.analytics.northwestern.edu/adidier/Documents/Deep_Learning_Project/film_vgg_input"
...
cfg.vizfilt_timeout = 0      # Decrease for speed, increase for better viz. 0 = off.
...
def makedata(basepath):
    ...
    obj_classes = ['right', 'left', 'punch', 'nothing'] 
...
if cfg.vgglayers >= 1: # Block 1
    x = Convolution2D(64, (4, 4), activation='relu', padding='same', name='block1_conv1')(img_input)
    x = Convolution2D(64, (4, 4), activation='relu', padding='same', name='block1_conv2')(x)
    x = MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool')(x)
    if cfg.batchnorm: x = BatchNormalization()(x)
if cfg.vgglayers >= 2: # Block 2
    x = Convolution2D(128, (4, 4), activation='relu', padding='same', name='block2_conv1')(x)
    x = Convolution2D(128, (4, 4), activation='relu', padding='same', name='block2_conv2')(x)
